...
3. Another option that commonly needs tweaking is na: this specifies the value (or values) that are used to represent missing values in your file:
...
```{r}
library(feather)
write_feather(challenge,"../data_output/challenge.feather")
read_feather("../data_output/challenge.feather")
```
